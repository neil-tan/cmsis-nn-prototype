...
{    
    ctx.add(new BinaryTensor<int>({2}, inline_MatMul_eightbit_x__port__0_quantize_transpose_const_0), 
            "MatMul_eightbit/x__port__0/quantize_transpose_const:0", 
            1);
}
{
    ctx.add(new RamTensor<uint8_t>(), "MatMul_eightbit/x__port__0/quantize_transpose:0", 1);
    ctx.push(new ReshapeOp(), 
             { "MatMul_eightbit/x__port__0/quantize:0", "MatMul_eightbit/x__port__0/quantize_transpose_const:0" },
             { "MatMul_eightbit/x__port__0/quantize_transpose:0" });
    ctx.eval();
}
{
    ctx.add(new RamTensor<q7_t>(), "MatMul_eightbit/x__port__0/quantize_q7:0", 1);
    ctx.push(new Uint8Q7OriginOp(),
             { "MatMul_eightbit/x__port__0/quantize_transpose:0", "MatMul_eightbit/x__port__0/quantize:1", "MatMul_eightbit/x__port__0/quantize:2" }, 
...
{
    ctx.add(new RamTensor<q7_t>(), "Variable_quantized_const_q7:0", 1);
    ctx.push(new Uint8Q7OriginOp(),
...
{    
    ctx.add(new BinaryTensor<int>({784,1}, inline_cmsis_fc_MatMul_eightbit_bias_bias_0), 
            "cmsis_fc_MatMul/eightbit_bias_bias:0", 
            1);
}
{    
    ctx.add(new BinaryTensor<uint16_t>({1}, inline_MatMul_eightbit_bShift_0), 
            "MatMul/eightbit_bShift:0", 
            1);
}
{    
    ctx.add(new BinaryTensor<uint16_t>({1}, inline_MatMul_eightbit_oShift_0), 
            "MatMul/eightbit_oShift:0", 
            1);
}
{    
    ctx.add(new RamTensor<uint16_t>({1,784}), "cmsis_scratch_MatMul/eightbit:0", 1);
}
{
    ...
    ctx.push(new FullyConnectedLayerCmsisOp<int>(),
              { "MatMul_eightbit/x__port__0/quantize_q7:0", "Variable_quantized_const_q7:0", "cmsis_fc_MatMul/eightbit_bias_bias:0", "MatMul/eightbit_bShift:0", "MatMul/eightbit_oShift:0", "cmsis_scratch_MatMul/eightbit:0" },
...
{    
    ctx.add(new BinaryTensor<int>({2}, inline_Relu_eightbit_transpose_const_0), 
            "Relu/eightbit_transpose_const:0", 
            1);
}
{
    ctx.add(new RamTensor<uint8_t>(), "Relu/eightbit_transpose:0", 1);
    ctx.push(new ReshapeOp(), 
             { "Relu/eightbit:0", "Relu/eightbit_transpose_const:0" },
             { "Relu/eightbit_transpose:0" });
    ctx.eval();
}
{
    ctx.add(new RamTensor<q7_t>(), "Relu/eightbit_q7:0", 1);
    ctx.push(new Uint8Q7OriginOp(),
             { "Relu/eightbit_transpose:0", "Relu/eightbit:1", "Relu/eightbit:2" }, 
             { "Relu/eightbit_q7:0" });
    ctx.eval();
}
{    
...
{
    ctx.add(new RamTensor<q7_t>(), "Variable_2_quantized_const_q7:0", 1);
    ctx.push(new Uint8Q7OriginOp(),
...
{    
    ctx.add(new BinaryTensor<int>({128,1}, inline_cmsis_fc_MatMul_1_eightbit_bias_bias_0), 
            "cmsis_fc_MatMul_1/eightbit_bias_bias:0", 
            1);
}
{    
    ctx.add(new BinaryTensor<uint16_t>({1}, inline_MatMul_1_eightbit_bShift_0), 
            "MatMul_1/eightbit_bShift:0", 
            1);
}
{    
    ctx.add(new BinaryTensor<uint16_t>({1}, inline_MatMul_1_eightbit_oShift_0), 
            "MatMul_1/eightbit_oShift:0", 
            1);
}
{    
    ctx.add(new RamTensor<uint16_t>({1,128}), "cmsis_scratch_MatMul_1/eightbit:0", 1);
}
{
    ...
    ctx.push(new FullyConnectedLayerCmsisOp<int>(),
              { "Relu/eightbit_q7:0", "Variable_2_quantized_const_q7:0", "cmsis_fc_MatMul_1/eightbit_bias_bias:0", "MatMul_1/eightbit_bShift:0", "MatMul_1/eightbit_oShift:0", "cmsis_scratch_MatMul_1/eightbit:0" },
